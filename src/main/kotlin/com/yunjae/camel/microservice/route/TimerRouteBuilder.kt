...
import com.yunjae.camel.microservice.process.SimpleLoggingProcessor
...
//@Component
class TimerRouteBuilder(context: CamelContext?, val currentTimeBean: CurrentTimeBean) : RouteBuilder(context) {
